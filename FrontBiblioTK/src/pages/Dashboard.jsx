	...
	if (!visibleLoans.length)
		return (
			<div className="empty-state">
				<strong>Aún no tienes préstamos</strong>
				...
				<tbody>
					{visibleLoans.map((loan) => (
						<tr key={loan.title}>
							...
							<td>{loan.due}</td>
							<td>
								<span className={`status ${loan.tone}`}>{loan.status}</span>
							</td>
						</tr>
					))}
				</tbody>
	...
	return (
		<div className="content">
			<header className="topbar">
				<div>
					<p className="eyebrow">Martes, 12 de marzo de 2024</p>
			...
			<section className="welcome-banner">
				<div>
					<p className="eyebrow">Tu rincón de lectura</p>
					<h2>
						Una página más,
						<br />
						un mundo nuevo.
					</h2>
					<p>Continúa explorando historias que te están esperando.</p>
				</div>
			</section>
			<div className="stats">
				<article>
